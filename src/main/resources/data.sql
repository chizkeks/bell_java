INSERT INTO Citizenship (code, name) VALUES(1, 'Российская федерация');
INSERT INTO Citizenship (code, name) VALUES(2, 'Соединенные штаты Америки');
INSERT INTO Citizenship (code, name) VALUES(3, 'Европейский союз');

INSERT INTO Doc_Type (code, name) VALUES(1, 'Паспорт');
INSERT INTO Doc_Type (code, name) VALUES(2, 'ИНН');
INSERT INTO Doc_Type (code, name) VALUES(3, 'Водительское удостоверение');
...
INSERT INTO Person (id, version, first_name, middle_name, surname, job_title, phone, office_id, citizenship_code)
...
INSERT INTO Document (person_id, doctype_code, number, issue_date)
